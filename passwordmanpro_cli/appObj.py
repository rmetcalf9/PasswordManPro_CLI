...
class AppObjClass():
  ...
  def _cmdJAVAPROPS(self, argv, curTime):
    ...
    #if len(argv) != 3:
    #  if len(argv) != 2:
    #    print('ERROR - javaprops needs 0 or x arguments "passwordmanpro_cli javaprops **RESOURSE_NAME_FILTER1** **RESOURSE_NAME_FILTER2**"')
    #    print('        you can specify as many RESOURSE_NAME_FILTER\'s as required and passwords that match ANY will be returned'
